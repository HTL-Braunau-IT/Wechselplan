...
describe('Teachers API', () => {
  ...
  describe('GET', () => {
    ...
    test('should handle database errors', async () => {
      vi.mocked(prisma.teacher.findMany).mockRejectedValue(new Error('Database connection failed'))
  ...
  describe('POST', () => {
    ...
    test('should handle database errors', async () => {
      vi.mocked(prisma.teacher.findUnique).mockResolvedValue(null)
      vi.mocked(prisma.teacher.create).mockRejectedValue(new Error('Database connection failed'))
