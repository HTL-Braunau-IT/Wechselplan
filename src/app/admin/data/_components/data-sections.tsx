...
export const adminDataSections: AdminDataSection[] = [
  {
    ...
    label: 'Schüler',
    icon: Users,
    description: 'Schülerdaten und Klassenzuordnungen verwalten',
    group: 'coreData',
  },
  {
    slug: 'teachers',
    label: 'Lehrkräfte',
    icon: GraduationCap,
    description: 'Lehrkräftedaten und Zuweisungen verwalten',
    group: 'coreData',
  },
  {
    slug: 'classes',
    label: 'Klassen',
    icon: Building,
    description: 'Klasseninformationen und Beziehungen verwalten',
    group: 'coreData',
  },
  {
    slug: 'subjects',
    label: 'Fächer',
    icon: BookOpen,
    description: 'Fachinformationen verwalten',
    group: 'coreData',
  },
  {
    slug: 'rooms',
    label: 'Räume',
    icon: Home,
    description: 'Rauminformationen und Kapazitäten verwalten',
    group: 'coreData',
  },
  {
    slug: 'learning-contents',
    label: 'Lehrinhalte',
    icon: FileText,
    description: 'Definitionen für Lehrinhalte verwalten',
    group: 'coreData',
  },
  {
    slug: 'group-assignments',
    label: 'Gruppenzuordnungen',
    icon: Users,
    description: 'Gruppenzuordnungen für Klassen verwalten',
    group: 'scheduling',
  },
  {
    slug: 'teacher-assignments',
    label: 'Lehrkraftzuordnungen',
    icon: BookOpen,
    description: 'Lehrkraftzuordnungen zu Klassen und Fächern verwalten',
    group: 'scheduling',
  },
  {
    slug: 'schedules',
    label: 'Stundenpläne',
    icon: Calendar,
    description: 'Stundenplan-Konfigurationen verwalten',
    group: 'scheduling',
  },
  {
    slug: 'schedule-times',
    ...
    icon: Clock,
    description: 'Unterrichtszeitfenster verwalten',
    group: 'scheduling',
  },
  {
    slug: 'break-times',
    label: 'Pausenzeiten',
    icon: Clock,
    description: 'Pausenzeitfenster verwalten',
    group: 'scheduling',
  },
  {
    ...
    label: 'Schulferien',
    icon: Calendar,
    description: 'Ferienzeiträume verwalten',
    group: 'scheduling',
  },
  {
    slug: 'school-years',
    label: 'Schuljahre',
    icon: Calendar,
    description: 'Schuljahre und Semestertermine verwalten',
    group: 'scheduling',
  },
  {
    slug: 'teacher-rotations',
    label: 'Lehrkraftrotationen',
    icon: RotateCcw,
    description: 'Rotationspläne der Lehrkräfte verwalten',
    group: 'scheduling',
  },
  {
    slug: 'schedule-pdfs',
    label: 'Stundenplan-PDFs',
    icon: FileText,
    description: 'Erzeugte Stundenplan-PDFs verwalten',
    group: 'scheduling',
  },
  {
    slug: 'roles',
  ...
  },
  {
    ...
    icon: Shield,
    description: 'Rollenzuweisungen für Benutzer verwalten',
    group: 'access',
  },
  {
    ...
    icon: MessageSquare,
    description: 'Support-Nachrichten und Feedback verwalten',
    group: 'support',
  },
  {
    slug: 'student-photos',
    label: 'Schülerfotos',
    icon: Image,
    description: 'Schülerfotos klassenweise hochladen (Nachname_Vorname.jpg)',
    group: 'support',
    requiresFeature: 'student_photos',
  },
]
