...
export function PeriodTabs({
	...
	const periods: Array<{ period: Period; label: string; subject?: string; first: boolean; second: boolean }> = [
		{
			period: 'AM',
	...
	return (
		<Tabs value={value} onValueChange={(v) => onValueChange(v as Period)}>
			<TabsList className="mb-2 flex h-auto flex-wrap justify-start gap-2 bg-transparent p-0 text-foreground">
