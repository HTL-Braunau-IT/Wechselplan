			...
			<TabsList className="flex h-auto flex-wrap gap-2 bg-transparent p-0 text-foreground">
				{teacherClasses.map((cls) => (
					<TabsTrigger
						...
						className="group flex items-center gap-3 rounded-lg px-4 py-2.5 text-sm font-medium shadow-sm transition-all hover:bg-muted/80 data-[state=active]:shadow-md data-[state=active]:ring-2 data-[state=active]:ring-inset data-[state=active]:ring-primary"
					>
						...
						<span className="flex items-center gap-2 text-xs font-normal opacity-90">
							<CompletionBadge
								...
								className="flex items-center gap-1 rounded-md bg-background/60 px-2 py-0.5"
							/>
							<CompletionBadge
